...
public class Alumno implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "alumnoCalificado", cascade = CascadeType.ALL)
    private List<Nota> notas;

    @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    @JoinTable(
        name="alumno_matriculado_asignatura",
        joinColumns = @JoinColumn(name="alumnos_alumno_id"),
        inverseJoinColumns = @JoinColumn(name="asignaturas_asignatura_id")
    )
